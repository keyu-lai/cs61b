...
public class IntListTest {
    ...
    public void testdSquareListIterative() {
      IntList L = IntList.list(1, 2, 3);
      IntList result = IntList.squareListIterative(L);
    ...
    public void testDcatenate() {
        IntList L = IntList.list(1, 2, 3);
        IntList.dcatenate(L, IntList.list(4, 5, 6, 7));
        assertEquals(IntList.list(1, 2, 3, 4, 5, 6, 7), L);
    }

    @Test 
    public void testCatenate() {
        IntList L = IntList.list(1, 2, 3);
        IntList result = IntList.catenate(L, IntList.list(4, 5, 6));
