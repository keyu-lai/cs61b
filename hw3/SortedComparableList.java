...
public class SortedComparableList {
    ...
    public void insert(Comparable c) {
        if(c.compareTo(head) < 0) {
            ...
            if(tail == null)
                tail = new SortedComparableList(c, tail);
            else
                tail.insert(c);
        }
    }
    ...
    public void extend(SortedComparableList that) {
        if(tail != null)
            ...
            SortedComparableList tmp1 = this;
            SortedComparableList tmp2 = that;
            while(tmp2 != null) {
                tmp1.tail = new SortedComparableList(tmp2.head, null);
                tmp1 = tmp1.tail;
                tmp2 = tmp2.tail;
            }
        }
    ...
    public static SortedComparableList subTail(SortedComparableList L, int start) {
        if(L == null)
            ...
            return new SortedComparableList(L.head, SortedComparableList.subTail(L.tail, start));
        } else 
    ...
    public static SortedComparableList sublist(SortedComparableList L, int start, int len) {
        if(L == null || len == 0) 
            ...
            return new SortedComparableList(L.head, SortedComparableList.sublist(L.tail, 0, len-1));
        else 
    ...
    public void squish() {
        ...
        SortedComparableList tmp = this;
        while(tmp.tail != null) {
            if(tmp.tail.head.equals(last)) {
