...
public class Plotter {
    ...
    public static void plotTS(TimeSeries<? extends Number> ts, String title, 
      ...
      Chart chart = QuickChart.getChart(title, ylabel, xlabel, legend, ts.years(), ts.data());
    ...
    public static void plotCountHistory(NGramMap ngm, String word, 
      ...
      for (int i = startYear; i <= endYear; ++i) {
          xValues.add(i);
          yValues.add(ngm.countInYear(word, i));
      }  

      Chart chart = QuickChart.getChart(null, "Years", "Data", null, xValues, yValues);
      new SwingWrapper(chart).displayChart();     
    }
    ...
    public static void plotWeightHistory(NGramMap ngm, String word, 
                                       int startYear, int endYear) {
      plotTS(ngm.weightHistory(word, startYear, endYear), null, "Years", "Data", null);
    }
    ...
    public static void plotProcessedHistory(NGramMap ngm, int startYear, int endYear,
      ...
      plotTS(ngm.processedHistory(yrp), null, "Years", "Data", null);     
    }
    ...
    public static void plotCategoryWeights(NGramMap ngm, WordNet wn, String categoryLabel,
                                            int startYear, int endYear) {
      plotTS(ngm.summedWeightHistory(wn.hyponyms(categoryLabel), startYear, endYear), categoryLabel, "Years", "Data", null);
    }
    ...
    public static void plotCategoryWeights(NGramMap ngm, WordNet wn, String[] categoryLabels,
      ...
      for(String categoryLabel: categoryLabels) {
        TimeSeries<Double> ts = ngm.summedWeightHistory(wn.hyponyms(categoryLabel), startYear, endYear);
        chart.addSeries(categoryLabel, ts.years(), ts.data());
      }
     new SwingWrapper(chart).displayChart();
    }
